...
const MOCK_FEED = [
  {
    ...
    caption: 'A p-value tells you how surprising your result is if the null hypothesis was true.',
  ...
  },
  {
    ...
    caption: 'Instead of one exact guess, we give a range of reasonable values.',
  ...
  },
  {
    ...
    caption: 'Loops let your code repeat a task without writing the same line again and again.',
  ...
  },
  {
    ...
    caption: 'No matter the original distribution, sample means cluster into a normal curve.',
  ...
  },
  {
    ...
    caption: 'Big O tells you how an algorithm\'s runtime grows as the input size increases.',
